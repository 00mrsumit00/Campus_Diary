...
<body>
    ...
    <div class="profile-dropdown" hidden>
        ...
        <a href="../Home/dashboard-index.php" class="dashboard"><i class="uil uil-create-dashboard"></i> My
            Dashboard</a>
        <a href="../Notes/notes-index.php" class="menu-item">Notes</a>
        <a href="../Code/code-index.php" class="menu-item">Codes</a>
        <a href="../Payment/pay-index.php" class="menu-item">Payment</a>
    ...
    <div class="drop-down" hidden>
        ...
        <a href="../Code/code-index.php">Codes</a>
